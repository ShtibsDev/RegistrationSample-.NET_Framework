...
namespace RegistrationSample.DesktopUI.Utility
{
    /// <summary>
    ...
    public sealed class AsyncRelayCommand : ObservableObject, IAsyncRelayCommand
    {
        ...
        public Task? ExecutionTask
        {
            ...
            private set
            {
                if (SetPropertyAndNotifyOnCompletion(ref executionTask, value, _ =>
                {
        ...
        /// <inheritdoc/>
        public bool CanBeCanceled => cancelableExecute is not null && IsRunning;
        ...
        {
            return canExecute?.Invoke() != false && !IsRunning;
        }
